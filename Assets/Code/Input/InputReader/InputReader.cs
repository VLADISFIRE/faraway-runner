...
{
    public abstract class InputReader : IDisposable, IInputReader
    {
        ...
        public InputReader(IEventsManager eventsManager)
        {
            _eventsManager = eventsManager;

            _eventsManager.Subscribe(EventsType.Update, Update);
        }

        public void Dispose()
        {
            _eventsManager.Unsubscribe(EventsType.Update, Update);
        }
